...
import org.copticchurchlibrary.arabicreader.ui.MusicPlayerActivity;
import org.copticchurchlibrary.arabicreader.utils.LogHelper;
import org.copticchurchlibrary.arabicreader.utils.ResourceHelper;
...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    public MediaNotificationManager(MusicService service) throws RemoteException {
        ...
        mNotificationColor = ResourceHelper.getThemeColor(mService, org.copticchurchlibrary.arabicreader.R.attr.colorPrimary,
                Color.DKGRAY);
    ...
    private Notification createNotification() {
        ...
        if ((mPlaybackState.getActions() & PlaybackStateCompat.ACTION_SKIP_TO_PREVIOUS) != 0) {
            notificationBuilder.addAction(org.copticchurchlibrary.arabicreader.R.drawable.ic_skip_previous_white_24dp,
                        mService.getString(org.copticchurchlibrary.arabicreader.R.string.label_previous), mPreviousIntent);
        ...
        if (mController != null && mController.getExtras() != null) {
            ...
            if (castName != null) {
                ...
                notificationBuilder.addAction(org.copticchurchlibrary.arabicreader.R.drawable.ic_close_black_24dp,
                        mService.getString(org.copticchurchlibrary.arabicreader.R.string.stop_casting), mStopCastIntent);
            }
        }
    ...
    private void addPlayPauseAction(NotificationCompat.Builder builder) {
        ...
        if (mPlaybackState.getState() == PlaybackStateCompat.STATE_PLAYING) {
            label = mService.getString(org.copticchurchlibrary.arabicreader.R.string.label_pause);
            icon = org.copticchurchlibrary.arabicreader.R.drawable.uamp_ic_pause_white_24dp;
            intent = mPauseIntent;
        } else {
            label = mService.getString(org.copticchurchlibrary.arabicreader.R.string.label_play);
            icon = org.copticchurchlibrary.arabicreader.R.drawable.uamp_ic_play_arrow_white_24dp;
            intent = mPlayIntent;
        }
